    ...
    return (
        <>
            <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
                ...
                </div><p id="cart-empty" className="hidden text-center py-8">
                    Ooops... Cart is empty
                    <a href="details.html" className="underline"> Shop Now</a>
                </p><div className="flex flex-start flex-wrap items-center mb-4 -mx-4"
                    data-row="1">
                    <div className="px-4 flex-none">
                ...
                </div><div className="flex flex-start flex-wrap items-center mb-4 -mx-4"
                    data-row="2">
                    <div className="px-4 flex-none">
                        <div className="" style={{width: 90, height: 90}}>
                            <img
