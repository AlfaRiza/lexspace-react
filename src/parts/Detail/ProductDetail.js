...
import ImageShowcaseFront1 from 'assets/images/showcase-1.front.jpg';
import ImageShowcaseBack1 from 'assets/images/showcase-1.back.jpg';
import ImageShowcaseRear1 from 'assets/images/showcase-1.rear.jpg';
import ImageShowcaseSide1 from 'assets/images/showcase-1.side.jpg';
import ImageShowcase1 from 'assets/images/showcase-1.top.jpg';
                    ...
                    <div class="slider">
                        <div class="thumbnail">
                            <div class="px-2">
                                <div
                                    class="item selected"
                                    data-img={ImageShowcaseFront1}
                                >
                                    <img
                                        src={ImageShowcaseFront1}
                                        alt="front"
                            ...
                            <div class="px-2">
                                <div
                                    class="item"
                                    data-img={ImageShowcaseBack1}
                                >
                                    <img
                                        src={ImageShowcaseBack1}
                                        alt="back"
                                        class="object-cover w-full h-full rounded-lg"
                                    />
                                </div>
                            ...
                            <div class="px-2">
                                <div
                                    class="item"
                                    data-img={ImageShowcaseRear1}
                                >
                                    <img
                                        src={ImageShowcaseRear1}
                                        alt="rear"
                                        class="object-cover w-full h-full rounded-lg"
                                    />
                                </div>
                            ...
                            <div class="px-2">
                                <div
                                    class="item"
                                    data-img={ImageShowcaseSide1}
                                >
                                    <img
                                        src={ImageShowcaseSide1}
                                        alt="side"
                                        class="object-cover w-full h-full rounded-lg"
                                    />
                                </div>
